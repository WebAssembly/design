 ...
 * To maintain good polyfill performance, the polyfill library will diverge from the
   specified WebAssembly semantics in certain corner case scenarios.
 * See the [Polyfill to asm.js page](Polyfill.md) for more details.
